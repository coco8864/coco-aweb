...
public class QueueManager implements Timer{
	...
	/* chat */
	public boolean createWsq(Object wsqWatcher,String name){
		return createWsq(wsqWatcher,name,0);
	}
	
	/* stress,connection */
	public boolean createWsq(Object wsqWatcher,String name,long interval){
		return false;
	}
	
	/* command */
	public boolean createWsq(Object wsqWatcher,AuthSession session,long timeout){
		return false;
	}
